...
### Optimistic settings
```bash
sbatch submit_main_HPC.sh --config optimistic --simulations 500 --chunk-size 2_250_000 --n-chunks 1 --n-sub-chunks 50 --cgw --s1-time "00:35:00" --s1-mem "12G" --s2-time "03:00:00" --s2-mem "15G" --snr-range 3.0 3.4 --synthetic-ptas --sim-start 611
```

### Pessimistic settings
```bash
sbatch submit_main_HPC.sh --config pessimistic --simulations 500 --chunk-size 24_000_000 --n-chunks 8 --n-sub-chunks 6 --cgw --s1-time "01:40:00" --s1-mem "13G" --s2-time "03:30:00" --s2-mem "15G" --snr-range 3.0 3.4 --synthetic-ptas --sim-start 1311
```

### Realistic settings
```bash
sbatch submit_main_HPC.sh --config realistic --simulations 500 --chunk-size 25_000_000 --n-chunks 4 --n-sub-chunks 10 --cgw --s1-time "01:20:00" --s1-mem "13G" --s2-time "03:00:00" --s2-mem "15G" --snr-range 3.0 3.4 --synthetic-ptas --sim-start 711
```
0
### Test settings
```bash
